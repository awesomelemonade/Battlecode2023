...
public class BFSVisionTemplate {
    ...
    public static void postLoop() throws GameActionException {
        BFSVisionTemplate bfs = allBFS[Cache.MY_LOCATION.x][Cache.MY_LOCATION.y];
        if (bfs == null) {
            bfs = new BFSVisionTemplate();
            allBFS[Cache.MY_LOCATION.x][Cache.MY_LOCATION.y] = bfs;
        }
        bfs.bfs();
        debug_render(bfs);
    }
    ...
    public void bfs() throws GameActionException  {
        while (Clock.getBytecodesLeft() > 1000 && !queue.isEmpty()) {
