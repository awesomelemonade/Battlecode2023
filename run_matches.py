...
#bots = ['beforeBetterEnemyHqPredictions', 'beforeCarrierAttack', 'beforeBuildOrder', 'beforeBuildLocations', 'noCheckerboard', 'beforeScoringMicro', 'noCheckerboardNoAdjacent', 'beforeTrafficControl', 'beforeWellTracker2']
